...
/*
    Scripts para crear los indices.
*/
...
-- Este bloque queda comentado intencionalmente.
-- Para una base nueva, quitar este comentario de bloque.
-- Para una base desplegada, ejecutar la migracion separada.
-- ============================================================
...
-- Para una base nueva, quitar este comentario de bloque.
-- Para una base desplegada, ejecutar la migracion separada.
-- Reutiliza el indice creado en el bloque de inscripciones.
-- ============================================================
