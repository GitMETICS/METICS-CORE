...
namespace webMetics.Controllers
{
    public class CalificacionesController : Controller
    {
        ...
        public CalificacionesController(IWebHostEnvironment environment, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, EmailService emailService)
        {
